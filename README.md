...
VR Payment integration for JTL 5.5, 5.6 and 5.7
=============================
...
[Documentation](https://docs.plugin-documentation.vr-payment.de/vr-payment/jtl-5/1.0.49/docs/en/documentation.html)
