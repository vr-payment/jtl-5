...
(function (window) {
    ...
    const VRPaymentCheckout = {
        ...
        /**VRPayment_CheckoutPaymentContentControl
         * Get iframe
         */
        getIframe: function () {
            ...
            if (!VRPaymentCheckout.handler) { // iframe has not been loaded yet
                ...
                // noinspection JSUnresolvedFunction
                VRPaymentCheckout.handler.setValidationCallback((validationResult) => {
                ...
                VRPaymentCheckout.handler.setInitializeCallback(() => {
                    let loader = document.getElementById(VRPaymentCheckout.loader_id);
                ...
                VRPaymentCheckout.handler.setHeightChangeCallback((height)=>{
                    setTimeout(function () {
                        if(height < 30) {
                            VRPaymentCheckout.handler.submit();
                        }
